...
public class MetamodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MetamodelPackage.PARTICIPANT: {
			...
			if (result == null)
				result = caseEntity(participant);
			if (result == null)
				result = caseNetworkCommunicator(participant);
			if (result == null)
				result = caseDirectCommunicator(participant);
			if (result == null)
				result = caseIdentifier(participant);
			if (result == null)
				result = caseNamedElement(participant);
			if (result == null)
				result = caseNetworkConnector(participant);
			if (result == null)
		...
		case MetamodelPackage.VEHICLE: {
			...
			if (result == null)
				result = caseDirectCommunicator(vehicle);
			if (result == null)
				result = caseNetworkCommunicator(vehicle);
			if (result == null)
				result = caseEntity(vehicle);
			if (result == null)
				result = caseNetworkConnector(vehicle);
			if (result == null)
				result = caseIdentifier(vehicle);
			if (result == null)
