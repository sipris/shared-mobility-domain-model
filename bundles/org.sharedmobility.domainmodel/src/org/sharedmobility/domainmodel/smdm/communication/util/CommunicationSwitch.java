...
public class CommunicationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case CommunicationPackage.NETWORK_COMMUNICATOR: {
			...
			if (result == null)
				result = caseNetworkConnector(networkCommunicator);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CommunicationPackage.NETWORK_CONNECTOR: {
		...
		case CommunicationPackage.DIRECT_COMMUNICATOR: {
