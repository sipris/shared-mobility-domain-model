/**
 */
package org.sharedmobility.domainmodel.smdm.communication.util;
...
public class CommunicationAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected CommunicationSwitch<Adapter> modelSwitch = new CommunicationSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sharedmobility.domainmodel.smdm.communication.NetworkCommunicator <em>Network Communicator</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sharedmobility.domainmodel.smdm.communication.NetworkConnector <em>Network Connector</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sharedmobility.domainmodel.smdm.communication.DirectCommunicator <em>Direct Communicator</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
