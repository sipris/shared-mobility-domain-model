...
/**
 * This is the item provider adapter for a {@link model.Inspector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InspectorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inspector_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inspector_id_feature", "_UI_Inspector_type"),
				 SharedMobilityPackage.Literals.INSPECTOR__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		BigInteger labelValue = ((Inspector)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Inspector.class)) {
			case SharedMobilityPackage.INSPECTOR__ID:
