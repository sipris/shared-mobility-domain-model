...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.MOBILITY_SERVICE_PROVIDER: {
			...
			case ModelPackage.RIDE_POOLING_PROVIDER: {
			...
			case ModelPackage.CARPOOLING_PROVIDER: {
			...
			case ModelPackage.RESERVATION_SERVICE_: {
			...
			case ModelPackage.REGISTRATION_SERVICE_: {
			...
			case ModelPackage.TRAFIC_LIGHT: {
